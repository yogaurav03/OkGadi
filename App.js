...
export default class App extends Component {
  ...
  fetchAddress = () => {
    fetch("https://maps.googleapis.com/maps/api/geocode/json?address=" + this.state.region.latitude + "," + this.state.region.longitude + "&key=" + "AIzaSyDN4R7HZLD43x5kbWer_Vi-UaAFZVFIw0U")
